...
iddelete	<INPUT TYPE="radio" NAME="isdelete" value="0" ${info==null||info.isdelete==false?'checked':''}>正常
<INPUT TYPE="radio" NAME="isdelete" value="1" ${info!=null&&info.isdelete==true?'checked':''}>删除<br>
请选择您的角色：
<c:forEach items="${roles}" var="role">
<INPUT TYPE="checkbox" NAME="rids" value="${role.rid}" >${role.rname}
</c:forEach>
<br>
