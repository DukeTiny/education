...
public class ReadAndWrite {
    ...
    private final File file = new File("/Users/duke_tiny/Desktop/CodeFiles/cxz/JavaIdea/java_practise/src/com/sia/java/atm/atm6/userInfo.xls");
    ...
    static  {
        ...
        try {
             poi = new POIFSFileSystem(new FileInputStream("/Users/duke_tiny/Desktop/CodeFiles/cxz/JavaIdea/java_practise/src/com/sia/java/atm/atm6/userInfo.xls"));
        ...
        if ( wb1.getSheetAt(0).getRow(0)==null ){
            try {
                ...
                OutputStream out = new FileOutputStream( "/Users/duke_tiny/Desktop/CodeFiles/cxz/JavaIdea/java_practise/src/com/sia/java/atm/atm6/userInfo.xls" );
