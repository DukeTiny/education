...
<body>
    <table align="center" width="600px">
        ...
        <c:forEach var="user" items="${sessionScope.users}" varStatus="index" begin="0" end="${sessionScope.pn.maxRows-1}">
            <tr align="center">
                <td><c:out value="${sessionScope.pn.pageNum*3+index.index-2}" /></td>
                <td>${user.uid}</td>
                <td>${user.uname}</td>
